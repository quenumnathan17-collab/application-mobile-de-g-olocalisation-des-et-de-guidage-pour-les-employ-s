...
const fieldSx = {
  "& .MuiOutlinedInput-root": {
    ...
    "&.Mui-focused": {
      bgcolor: "#ffffff",
      boxShadow: "0 4px 16px rgba(105,180,245,0.15)",
    },
  ...
  return (
    <>
      ...
      <form onSubmit={handleRegister}>
        ...
        >
          <Box
            ...
            sx={{
              ...
              overflow: "hidden",
              background: dragOver ? "rgba(59,94,219,0.06)" : "#f0f4fb",
              transition: "all 0.2s",
              "&:hover": {
                borderColor: "#69b4f5",
                background: "rgba(105,180,245,0.08)",
          ...
          >
            {avatar ? (
              ...
              <Box sx={{ textAlign: "center", px: 1 }}>
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "#5e7290", fontWeight: 600, lineHeight: 1.2 }}
                >
                  Votre photo
                </Typography>
              </Box>
        ...
        <TextField
          fullWidth
          label="Code d'invitation entreprise *"
          variant="outlined"
          margin="dense"
      ...
      >
        ...
        <Box
          sx={{
            ...
            position: "relative",
            background:
              "linear-gradient(160deg,#1a2244 0%,#2d3a6d 25%,#3b5edb 50%,#4a9de8 75%,#69b4f5 100%)",
            overflow: "hidden",
            p: 6,
          }}
        >
          ...
          <Box
            sx={{
              ...
              height: 300,
              borderRadius: "50%",
              background: "rgba(105,180,245,0.2)",
              filter: "blur(80px)",
          ...
          >
            ...
            >
              Votre plateforme cloud multi-entreprises pour coordonner vos
              collaborateurs et simplifier leurs interventions sur le terrain.
            </Typography>
        ...
        <Box
          sx={{
            ...
            p: { xs: 3, sm: 5 },
            background: {
              xs: "linear-gradient(160deg,#1a2244 0%,#2d3a6d 25%,#3b5edb 50%,#4a9de8 75%,#69b4f5 100%)",
              md: "linear-gradient(180deg,#f8fafc 0%,#eef3fa 100%)",
            },
            position: "relative",
            overflowY: "auto",
          }}
        >
          ...
          <Box
            sx={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle,rgba(105,180,245,0.15) 0%,transparent 70%)",
              pointerEvents: "none",
            }}
          />
          ...
          <Paper
            ...
            sx={{
              ...
              boxShadow:
                "0 32px 64px -16px rgba(45,58,109,0.1),0 0 0 1px rgba(255,255,255,0.5) inset",
              zIndex: 1,
              position: "relative",
              my: 4,
            }}
          >
            ...
            >
              ...
              >
                Votre plateforme cloud pour coordonner vos collaborateurs et
                simplifier leurs interventions sur le terrain.
              </Typography>
              <Box
                sx={{
                  display: "flex",
              ...
              >
                {["Cartographie", "Guidage GPS", "Équipes", "Multi-Tenant"].map(
                  (f, i) => (
                    <Box
                      key={i}
                      sx={{
            ...
            >
              ...
              <Tab
                ...
                aria-controls="panel-register-company"
              />
            </Tabs>
            ...
            >
              {tab === 0 && (
                <LoginForm onLoginSuccess={onLoginSuccess} apiUrl={apiUrl} />
              )}
            </Box>
            <Box
              role="tabpanel"
            ...
            <Box
              role="tabpanel"
              id="panel-register-company"
              aria-labelledby="tab-register-company"
              hidden={tab !== 2}
            >
              {tab === 2 && (
                <RegisterCompanyForm
          ...
          <Typography
            variant="caption"
            sx={{
              color: { xs: "rgba(255,255,255,0.5)", md: "#8899b5" },
              fontWeight: 500,
              mb: 3,
            }}
          >
