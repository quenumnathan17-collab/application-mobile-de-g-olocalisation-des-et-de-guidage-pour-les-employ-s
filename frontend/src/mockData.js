// Données initiales fictives adaptées à la Côte d'Ivoire
// (Abidjan) — Utilisées comme fallback hors ligne uniquement.
...
export const initialEmployees = [
  ...
  },
  {
    ...
    role: 'employee',
    status: 'active',
    gps: { lat: 5.3571, lng: -3.9897 },
    workingHours: { start: '08:00', end: '18:00' },
    avatar:
      'https://images.unsplash.com/photo-1531123897727' +
      '-8f129e1688ce?w=150&auto=format&fit=crop&q=80',
  },
  {
    id: 'emp_admin',
    name: 'Thomas Touré',
    ...
    status: 'active',
    avatar:
      'https://images.unsplash.com/photo-1472099645785' +
      '-5658abf4ff4e?w=150&auto=format&fit=crop&q=80',
  },
];
...
export const initialClients = [
  ...
  },
  {
    ...
    type: 'particulier',
    address:
      'Avenue 8, Rue 12, Zone 4, Marcory, Abidjan',
  ...
  },
  {
    ...
    type: 'particulier',
    address:
      'Cité CNPS, Angré 22e Arrondissement, ' +
      'Cocody, Abidjan',
...
export const initialOperations = [
  ...
  },
  {
    ...
    description:
      ...
      ' électronique et vidéosurveillance',
    date: '2026-06-18',
    employeeId: 'emp_1',
    status: 'planifiée',
  ...
  },
  {
    ...
    description:
      ...
      ' électrique et baies de brassage',
    date: '2026-06-18',
    employeeId: 'emp_2',
    status: 'en cours',
  ...
  },
  {
    ...
    description:
      ...
      ' et digitalisation des processus',
    date: '2026-06-19',
    employeeId: 'emp_2',
    status: 'planifiée',
